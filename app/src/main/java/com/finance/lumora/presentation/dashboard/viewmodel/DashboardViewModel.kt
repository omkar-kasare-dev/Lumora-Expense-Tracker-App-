...
class DashboardViewModel @Inject constructor(
    ...
    private fun navigateToAddTransaction() {
        viewModelScope.launch {
            _uiEffect.emit(DashboardUiEffect.NavigateToAddTransaction)
        }
    }
     ...
     */
    private fun navigateToTransactionDetails(transaction: TransactionWithCategory) {
        viewModelScope.launch {
            _uiEffect.emit(DashboardUiEffect.NavigateToTransactionDetails(transaction = transaction))
        }
    }
    ...
    private fun showSnackbar(message: String) {
        viewModelScope.launch {
            _uiEffect.emit(DashboardUiEffect.ShowSnackbar(message = message))
        }
    }
