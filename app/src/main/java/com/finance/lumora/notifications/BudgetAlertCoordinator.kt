...
class BudgetAlertCoordinator @Inject constructor(
    ...
    suspend fun evaluate() {
        ...
        // ---------------------------------------------------------
        // In-App Notification (Steps 8.4 / 8.5)
        // ---------------------------------------------------------
        //
        // Persist to the in-app Notification screen regardless of
        // whether the system tray notification was actually posted
        // (isPosted can be false if the user denied the OS
        // permission) - the in-app list is a separate concern from
        // the system tray and shouldn't be silently skipped just
        // because the tray notification failed.
        // ---------------------------------------------------------
        ...
        try {
            ...
            Log.e(TAG, "Failed to save in-app budget alert notification", e)
